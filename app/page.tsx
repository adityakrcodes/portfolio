...
export default function Home() {
  return (
    <div className="flex flex-col h-full">
        <div className="flex-1 flex md:flex-row flex-col-reverse justify-center items-center gap-10 md:px-10 w-7/12 mx-auto">
            ...
            <div className="md:w-3/4 w-12/12 flex justify-center items-center">
