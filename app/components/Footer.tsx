...
const socialLinks = [
  ...
  {
    name: "Email",
    href: "mailto:hi@adityakrcodes.com",
    icon: (
  ...
  return (
    <footer className="mt-auto border-t border-zinc-800/50">
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center font-bold text-black text-sm">
                AK
              </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            ...
            <p className={`text-zinc-600 text-xs ${text.className}`}>
        ...
        {/* Bottom decoration */}
        <div className="mt-8 pt-8 border-t border-zinc-800/30 flex justify-center">
          <p className={`text-zinc-600 text-xs flex items-center gap-2 ${text.className}`}>
            Crafted with
            <motion.span
